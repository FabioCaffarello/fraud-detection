...
from ddd_application.fake_factory.device_factory import DeviceLogFactory
from ddd_application.fake_factory.transaction_factory import TransactionFakeFactory
from ddd_application.fake_factory.user_profile_factory import UserProfileFactory
